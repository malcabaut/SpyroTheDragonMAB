...
import dam.pmdm.spyrothedragon.databinding.FragmentGuiaPaso03Binding;

public class GuiaPaso03Fragment extends Fragment {
    private static final String TAG = "GuiaPaso03Fragment";
    private FragmentGuiaPaso03Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentGuiaPaso03Binding.inflate(inflater, container, false);
